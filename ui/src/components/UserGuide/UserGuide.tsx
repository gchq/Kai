                    ...
                    <Card className={this.classes.card} style={{ maxWidth: 800 }}>
                        <CardContent>
                            ...
                            <Typography variant="body2" color="textSecondary" component="p">
                                When creating a new graph you need a unique Graph Name and a Schema.
                        ...
                        <CardActions style={{ justifyContent: 'center' }}>
                            <Button variant="outlined" color="primary" target="_blank" href="https://gchq.github.io/gaffer-doc/summaries/getting-started.html">
                                <GitHubIcon />Gaffer Documentation
                                </Button>
                        </CardActions>
                    </Card>
                </Grid>
