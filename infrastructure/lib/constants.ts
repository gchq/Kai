...
export const ADD_NAMESPACE_WORKER_BATCH_SIZE = 3; // can go up to 7
export const DELETE_NAMESPACE_WORKER_BATCH_SIZE = 3; // can go up to 7
...
const TIMEOUT_FOR_ADDING_NAMESPACE_IN_MINUTES = 2; // how long it should take for one namespace to be added
const TIMEOUT_FOR_DELETING_NAMESPACE_IN_MINUTES = 2; // how long it should take for one namespace to be deleted
...
export const ADD_NAMESPACE_TIMEOUT = Duration.minutes(TIMEOUT_FOR_ADDING_NAMESPACE_IN_MINUTES * ADD_NAMESPACE_WORKER_BATCH_SIZE);
export const DELETE_NAMESPACE_TIMEOUT = Duration.minutes(TIMEOUT_FOR_DELETING_NAMESPACE_IN_MINUTES * DELETE_NAMESPACE_WORKER_BATCH_SIZE);
